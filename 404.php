        ...
        <div class="not-found">
            <div class="not-found__container">
                <div class="not-found__content">
                    ...
                    <h1 class="not-found__title"><?php if(isset($options['error_404_title']) && strlen($options['error_404_title']) > 0): ?> <?php print $options['error_404_title']; ?><?php else: ?><?php print __('Page Not Found', 'community-portal'); ?><?php endif; ?></h1>
                    <p class="not-found__copy">
                        <?php if(isset($options['error_404_copy']) && strlen($options['error_404_copy']) > 0): ?>
                            <?php print $options['error_404_copy']; ?>
                        <?php else: ?>  

	...
	<section class="profile__section">
		<div class="profile__card">
			<div class="profile__card-header-container">
				...
				<div class="profile__edit-link-container profile__edit-link-container--mobile">
					<a href="/people/<?php echo esc_attr( $info['username']->value ); ?>/profile/edit/group/1" class="profile__link">
		...
		<div class="profile__card">
				<?php foreach ( $groups['groups'] as $gid ) : ?>
					...
					?>
			<a class="profile__group" href="/groups/<?php echo esc_attr( $group->slug ); ?>">
		...
		<div class="profile__card">
				<?php foreach ( $campaign_objects as $campaign ) : ?>
					<?php if ( $campaign ) : ?>
						...
						?>
		<a class="profile__campaign" href="/campaigns/<?php echo esc_attr( $campaign->post_name ); ?>">
	...
	<section class="profile__section profile__section--right">
		...
		<div class="profile__languages-card profile__card--right">
			...
			<?php foreach ( $info['languages']->value as $code ) : ?>
				<?php $index++; ?>
				<span>
					<a href="/people/?language=<?php echo esc_attr( $code ); ?>" class="profile__languages-link"><?php echo esc_html( $languages[ $code ] ); ?></a>

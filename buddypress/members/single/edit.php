...
<?php elseif ( true === $complete && true === $edit ) : ?>
	<script type="text/javascript">
		window.location = "/people/<?php echo $updated_username ? esc_attr( $updated_username ) : esc_attr( $user->user_nicename ); ?>";
	</script>
<?php else : ?>
	<div class="profile__hero">
		<div class="profile__hero-container">
			<div class="profile__hero-content">
				<h1 class="profile__title"><?php ( isset( $meta['agree'][0] ) && 'I Agree' === $meta['agree'][0] ) ? esc_html_e( 'Edit Profile', 'community-portal' ) : esc_html_e( 'Complete Profile', 'community-portal' ); ?></h1>
		...
		<section class="profile__form-container profile__form-container--first">
			<div class="profile__form-primary">
				...
				<div class="profile__select-container">
					<label class="profile__label"><?php esc_html_e( 'Visibility Settings', 'community-portal' ); ?></label>
			...
			<div class="profile__form-field">
				<div class="profile__input-container profile__input-container--profile">
					<label class="profile__label" for="image-url"><?php esc_html_e( 'Profile Photo (optional)', 'community-portal' ); ?></label>
						<?php
						if ( ( ! empty( $_SERVER['HTTPS'] ) && 'off' !== $_SERVER['HTTPS'] ) || ! empty( $_SERVER['SERVER_PORT'] ) && 443 === $_SERVER['SERVER_PORT'] ) {
							if ( isset( $form['image_url'] ) && strlen( $form['image_url'] ) > 0 ) {
								$avatar_url = preg_replace( '/^http:/i', 'https:', wp_unslash( $form['image_url'] ) );
							} else {
						...
						?>
						<div id="dropzone-photo-uploader" class="profile__image-upload"
						<?php
						if ( $form && isset( $form['image_url'] ) && strlen( $form['image_url'] ) > 0 ) :
							?>
							style="background: url('<?php echo esc_url( $avatar_url ); ?>') cover;"
							<?php
else :
	?>
							<?php
							if ( is_array( $community_fields ) && isset( $community_fields['image_url'] ) && strlen( $community_fields['image_url'] ) > 0 ) :
								?>
	style="background: url('<?php echo esc_url( $avatar_url ); ?>'); background-size: cover;"<?php endif; ?><?php endif; ?>>
							<div class="dz-message" data-dz-message="">
								<div class="profile__image-instructions">
									...
									if ( isset( $community_fields['image_url'] ) || strlen( $community_fields['image_url'] ) !== 0 ) :
										...
										<span><?php esc_html_e( 'minimum dimensions 175px by 175px', 'community-portal' ); ?></span>
									</button>
								</div>
	...
	?>
						<?php
						if ( is_array( $community_fields ) && isset( $community_fields['image_url'] ) ) :
							?>
							<?php echo esc_url( $community_fields['image_url'] ); ?><?php endif; ?><?php endif; ?>" />
				</div>
				<div class="profile__select-container">
					...
					<select id="profile-image-visibility" name="profile_image_url_visibility" class="profile__select">
						...
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( $form && isset( $form['profile_image_url_visibility'] ) && "{$key}" === $form['profile_image_url_visibility'] ) :
													?>
							selected
													<?php
else :
	?>
							<?php
							if ( isset( $community_fields['profile_image_url_visibility'] ) && "{$key}" === $community_fields['profile_image_url_visibility'] ) :
								?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
			</div>
			...
			<div class="profile__form-field">
				<div class="profile__input-container">
					<label class="profile__label" for="username"><?php esc_html_e( 'Username (required)', 'community-portal' ); ?></label>
					<input type="text" name="username" id="username" class="profile__input
					<?php
					if ( ! empty( $_SERVER['REQUEST_METHOD'] ) && 'POST' === $_SERVER['REQUEST_METHOD'] && ! isset( $form['username'] ) || ( isset( $form['username'] ) && empty( trim( $form['username'] ) ) || isset( $form['username_error_message'] ) ) ) :
						?>
						profile__input--error<?php endif; ?>" placeholder="<?php esc_attr_e( 'Username', 'community-portal' ); ?>" value="<?php echo isset( $form['username'] ) ? esc_attr( wp_unslash( $form['username'] ) ) : esc_attr( wp_unslash( $user->user_nicename ) ); ?>"  required/>
					<div class="form__error-container
					<?php
					if ( ! empty( $_SERVER['REQUEST_METHOD'] ) && 'POST' === $_SERVER['REQUEST_METHOD'] && ! isset( $form['username'] ) || ( isset( $form['username'] ) && empty( trim( $form['username'] ) ) || isset( $form['username_error_message'] ) ) ) :
						?>
	...
	?>
				...
				<div class="profile__select-container">
					...
					<select id="username-visibility" name="username_visibility" class="profile__select select--disabled" disabled>
						<option value="<?php echo esc_attr( PrivacySettings::PUBLIC_USERS ); ?>"><?php esc_html_e( 'Public (Everyone)', 'community-portal' ); ?></option>
					</select>
				</div>
			</div>
			<hr class="profile__keyline" />
			<div class="profile__form-field">
				<div class="profile__input-container">
					<label class="profile__label" for="first-name"><?php esc_html_e( 'First Name (required)', 'community-portal' ); ?></label>
					<input type="text" name="first_name" id="first-name" class="profile__input
					<?php
					...
					<span class="profile__input-desc"><?php esc_html_e( 'Your first name is always visible to registered users', 'community-portal' ); ?></span>
				</div>
				<div class="profile__select-container">
					<label class="profile__label" for=""><?php esc_html_e( 'Can be viewed by', 'community-portal' ); ?></label>
					<select id="firstname-visibility" name="first_name_visibility" class="profile__select">
						...
						<option value="<?php echo esc_html( $key ); ?>"
												...
												if ( isset( $meta['first_name_visibility'][0] ) && "{$key}" === $meta['first_name_visibility'][0] ) :
													?>
							selected<?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endif; ?>
						<?php endforeach; ?>
					</select>
				</div>
			...
			<div class="profile__form-field">
				<div class="profile__input-container">
					<label class="profile__label" for="last-name"><?php esc_html_e( 'Last Name (required)', 'community-portal' ); ?></label>
					<input type="text" name="last_name" id="first-name" class="profile__input
					<?php
					if ( ! empty( $_SERVER['REQUEST_METHOD'] ) && 'POST' === $_SERVER['REQUEST_METHOD'] && ! isset( $form['last_name'] ) || ( isset( $form['last_name'] ) && empty( trim( $form['last_name'] ) ) ) ) :
						?>
						profile__input--error<?php endif; ?>" placeholder="<?php esc_attr_e( 'Last Name', 'community-portal' ); ?>" value="<?php echo isset( $form['last_name'] ) ? esc_attr( wp_unslash( $form['last_name'] ) ) : esc_attr( wp_unslash( $meta['last_name'][0] ) ); ?>" required />
					<div class="form__error-container
					<?php
					if ( ! empty( $_SERVER['REQUEST_METHOD'] ) && 'POST' === $_SERVER['REQUEST_METHOD'] && ! isset( $form['last_name'] ) || ( isset( $form['last_name'] ) && empty( trim( $form['last_name'] ) ) ) ) :
						?>
			...
			<div class="profile__form-field">
				<div class="profile__select-container profile__select-container--full">
					<label class="profile__label" for="pronoun"><?php esc_html_e( 'Preferred Pronouns (optional)', 'community-portal' ); ?></label>
					<select id="pronoun" name="pronoun" class="profile__select">
						<option value=""><?php esc_html_e( 'Preferred Pronoun', 'community-portal' ); ?></option> 
						<?php foreach ( $pronouns as $p ) : ?>
						<option value="<?php echo esc_html( $p ); ?>"
												<?php
	...
	?>
							...
							if ( isset( $community_fields['pronoun'] ) && $community_fields['pronoun'] === $p ) :
								?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $p ); ?></option>
						<?php endforeach; ?>
					</select>
				</div>
				<div class="profile__select-container">
	...
	?>
				...
				<div class="profile__select-container">
					...
					<select id="profile-bio-visibility" name="profile_bio_visibility" class="profile__select">
						...
						<option value="<?php echo esc_html( $key ); ?>"
												<?php
												if ( $form && isset( $form['profile_bio_visibility'] ) && "{$key}" === $form['profile_bio_visibility'] ) :
													?>
							selected
													<?php
else :
	?>
							<?php
							if ( isset( $community_fields['profile_bio_visibility'] ) && "{$key}" === $community_fields['profile_bio_visibility'] ) :
								?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				<div class="profile__select-container profile__select-container--inline profile__select-container--half">
					<label class="profile__label" for="country"><?php esc_html_e( 'Country (optional)', 'community-portal' ); ?></label>
					<select id="country" name="country" class="profile__select">
						<option value="0"><?php esc_html_e( 'Country', 'community-portal' ); ?></option>
						<?php foreach ( $countries as $key    => $value ) : ?>
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( $form && isset( $form['country'] ) && $form['country'] === $key ) :
													?>
							selected
													<?php
else :
	?>
								<?php
								if ( isset( $community_fields['country'] ) && $community_fields['country'] === $key ) :
									?>
								selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
				...
				<div class="profile__input-container">
					<label class="profile__label" for="city"><?php esc_html_e( 'City (optional)', 'community-portal' ); ?></label>
					<input type="text" name="city" id="city" class="profile__input" placeholder="<?php esc_attr_e( 'City', 'community-portal' ); ?>" value="<?php echo isset( $form['city'] ) ? esc_attr( wp_unslash( $form['city'] ) ) : esc_attr( $community_fields['city'] ); ?>" maxlength="180" />
				</div>
				<div class="profile__select-container">
					<label class="profile__label" for=""><?php esc_html_e( 'Can be viewed by', 'community-portal' ); ?></label>
					<select id="profile-location-visibility" name="profile_location_visibility" class="profile__select">
						...
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( $form && isset( $form['profile_location_visibility'] ) && "{$key}" === $form['profile_location_visibility'] ) :
													?>
							selected
													<?php
else :
	?>
							<?php
							if ( isset( $meta['profile_location_visibility'][0] ) && "{$key}" === $meta['profile_location_visibility'][0] ) :
								?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				<div class="profile__input-container">
					<label class="profile__label" for="email"><?php esc_html_e( 'Email contact (required)', 'community-portal' ); ?></label>
					...
					if ( ! empty( $_SERVER['REQUEST_METHOD'] ) && 'POST' === $_SERVER['REQUEST_METHOD'] && ! isset( $form['email'] ) || ( isset( $form['email'] ) && empty( trim( $form['email'] ) ) || isset( $form['email_error_message'] ) ) ) :
						?>
						profile__input--error<?php endif; ?>" placeholder="<?php esc_attr_e( 'Email', 'community-portal' ); ?>" value="<?php echo isset( $form['email'] ) ? esc_attr( $form['email'] ) : esc_attr( $user->user_email ); ?>" required/>
					<div class="form__error-container
					<?php
					if ( ! empty( $_SERVER['REQUEST_METHOD'] ) && 'POST' === $_SERVER['REQUEST_METHOD'] && ! isset( $form['email'] ) || ( isset( $form['email'] ) && empty( trim( $form['email'] ) ) || isset( $form['email_error_message'] ) ) ) :
						?>
	...
	?>
				...
				<div class="profile__select-container">
					<label class="profile__label" for="email-visibility"><?php esc_html_e( 'Can be viewed by', 'community-portal' ); ?></label>
					<select id="email-visibility" name="email_visibility" class="profile__select">
						<?php foreach ( $visibility_options as $key   => $value ) : ?>
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( isset( $meta['email_visibility'][0] ) && "{$key}" === $meta['email_visibility'][0] ) :
													?>
							selected<?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				<div class="profile__input-container">
					<label class="profile__label" for="phone"><?php esc_html_e( 'Phone contact (optional)', 'community-portal' ); ?></label>
					<input type="text" name="phone" id="phone" class="profile__input" value="
					<?php
					if ( $form && isset( $form['phone'] ) ) :
						?>
	...
	?>
						<?php
						if ( is_array( $community_fields ) && isset( $community_fields['phone'] ) ) :
							?>
							<?php echo esc_attr( $community_fields['phone'] ); ?><?php endif; ?><?php endif; ?>"/>
				</div>
				<div class="profile__select-container">
					<label class="profile__label" for="profile-phone-visibility"><?php esc_html_e( 'Can be viewed by', 'community-portal' ); ?></label>
					<select id="profile-phone-visibility" name="profile_phone_visibility" class="profile__select">
						<?php foreach ( $visibility_options as $key   => $value ) : ?>
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( isset( $community_fields['profile_phone_visibility'] ) && "{$key}" === $community_fields['profile_phone_visibility'] ) :
													?>
							selected<?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
		...
		<section class="profile__form-container">
			<div class="profile__form-primary">
				<h2 class="profile__form-title"><?php esc_html_e( 'Social Links', 'community-portal' ); ?></h2>
				<div class="profile__select-container">
					<label class="profile__label"><?php esc_html_e( 'Visibility Settings', 'community-portal' ); ?></label>
			...
			<div class="profile__form-field">
				...
				<div class="profile__select-container">
					...
					<select id="profile-discourse-visibility" name="profile_discourse_visibility" class="profile__select">
						...
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( isset( $community_fields['profile_discourse_visibility'] ) && "{$key}" === $community_fields['profile_discourse_visibility'] ) :
													?>
							selected<?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				...
				<div class="profile__select-container">
					...
					<select id="profile-facebook-visibility" name="profile_facebook_visibility" class="profile__select">
						...
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( isset( $community_fields['profile_facebook_visibility'] ) && "{$key}" === $community_fields['profile_facebook_visibility'] ) :
													?>
							selected<?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				...
				<div class="profile__select-container">
					...
					<select id="profile-twitter-visibility" name="profile_twitter_visibility" class="profile__select">
						...
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( isset( $community_fields['profile_twitter_visibility'] ) && "{$key}" === $community_fields['profile_twitter_visibility'] ) :
													?>
							selected<?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				...
				<div class="profile__select-container">
					...
					<select id="profile-linkedin-visibility" name="profile_linkedin_visibility" class="profile__select">
						...
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( isset( $community_fields['profile_linkedin_visibility'] ) && "{$key}" === $community_fields['profile_linkedin_visibility'] ) :
													?>
							selected<?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				<div class="profile__input-container">
					<label class="profile__label" for="matrix"><?php esc_html_e( 'Matrix username (optional)', 'community-portal' ); ?></label>
					<?php
				...
				<div class="profile__select-container">
					<label class="profile__label" for="profile-matrix-visibility"><?php esc_html_e( 'Can be viewed by', 'community-portal' ); ?></label>
					<select id="profile-matrix-visibility" name="profile_matrix_visibility" class="profile__select">
						<?php foreach ( $visibility_options as $key   => $value ) : ?>
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( isset( $community_fields['profile_matrix_visibility'] ) && "{$key}" === $community_fields['profile_matrix_visibility'] ) :
													?>
							selected<?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<?php if ( count( $languages_spoken ) < 2 ) : ?>
				...
				<div class="profile__form-field profile__form-field--tight">
					<div class="profile__select-container profile__select-container--full profile__select-container--first">
						<label class="profile__label" for="pronoun"><?php esc_html_e( 'Languages spoken (optional)', 'community-portal' ); ?></label>
						<select id="languages-1" name="languages[]" class="profile__select">
							...
							<option value="<?php echo esc_attr( $key ); ?>"
													<?php
													if ( $form && isset( $form['langauges'][0] ) && $form['languages'][0] === $key ) :
														?>
								selected
														<?php
else :
	?>
								<?php
								if ( isset( $community_fields['languages'][0] ) && $community_fields['languages'][0] === $key ) :
									?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $language ); ?></option>
							<?php endforeach; ?>
						</select>
					</div>
			...
			<?php else : ?>
				...
				<?php foreach ( $languages_spoken as $index => $value ) : ?>
					<div class="profile__form-field profile__form-field--tight">
						...
						if ( $index > 0 ) :
							?>
							profile__select-container--no-label<?php endif; ?>
							<?php
							if ( 0 === $index ) :
								?>
							profile__select-container--first<?php endif; ?>">
						<?php
						if ( 0 === $index ) :
							?>
							<label class="profile__label" for="languages"><?php esc_html_e( 'Languages spoken (optional)', 'community-portal' ); ?></label><?php endif; ?>
							<select id="languages-<?php echo esc_attr( $index ); ?>" name="languages[]" class="profile__select
															<?php
															if ( $index > 0 ) :
																?>
								profile__select--short<?php endif; ?>">
								<option value=""><?php esc_html_e( 'Make Selection', 'community-portal' ); ?>
								<?php foreach ( $languages as $key    => $language ) : ?>
								<option value="<?php echo esc_attr( $key ); ?>"
														<?php
														if ( $form && isset( $form['languages'][ $index ] ) && $form['languages'][ $index ] === $key ) :
															?>
									selected
															<?php
else :
	?>
									<?php
									if ( isset( $community_fields['languages'][ $index ] ) && $community_fields['languages'][ $index ] === $key ) :
										?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $language ); ?></option>
								<?php endforeach; ?>
							</select>
						...
						<div class="profile__select-container profile__select-container--hide-mobile profile__select-container--flex">
							...
							<select id="profile-languages-visibility" class="profile__select profile__select--flex">
								...
								<option value="<?php echo esc_attr( $key ); ?>"
														<?php
														if ( $form && isset( $form['profile_languages_visibility'] ) && "{$key}" === $form['profile_languages_visibility'] ) :
															?>
									selected
															<?php
else :
			...
			<div class="profile__form-field">
				<div>
					<fieldset class="fieldset">
						<legend class="profile__label"><?php esc_html_e( 'Skills and interests (optional)', 'community-portal' ); ?></legend>
						<?php
							// Get all tags!
						...
						<div class="profile__tag-container">
							<?php foreach ( $tags as $loop_tag ) : ?>
								...
								if ( in_array( $loop_tag->slug, $form_tags, true ) ) :
									?>
									profile__tag--active<?php endif; ?>" for="<?php echo esc_attr( $loop_tag->slug ); ?>"><?php echo esc_html( $loop_tag->name ); ?></label>
							<?php endforeach; ?>
						</div>
						<?php
				...
				<div class="profile__select-container">
					<label class="profile__label" for="profile-tags-visibility"><?php esc_html_e( 'Can be viewed by', 'community-portal' ); ?></label>
					<select id="profile-tags-visibility" name="profile_tags_visibility" class="profile__select">
						<?php foreach ( $visibility_options as $key   => $value ) : ?>
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( $form && isset( $form['profile_tags_visibility'] ) && "{$key}" === $form['profile_tags_visibility'] ) :
													?>
							selected
													<?php
else :
	?>
							<?php
							if ( isset( $community_fields['profile_tags_visibility'] ) && "{$key}" === $community_fields['profile_tags_visibility'] ) :
								?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				...
				<div class="profile__select-container">
					...
					<select id="profile-groups-joined-visibility" name="profile_groups_joined_visibility" class="profile__select">
						...
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( $form && isset( $form['profile_groups_joined_visibility'] ) && "{$key}" === $form['profile_groups_joined_visibility'] ) :
													?>
													<?php else : ?>
														<?php
														if ( isset( $community_fields['profile_groups_joined_visibility'] ) && "{$key}" === $community_fields['profile_groups_joined_visibility'] ) :
															?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				...
				<div class="profile__select-container">
					...
					<select id="profile-events-attended-visibility" name="profile_events_attended_visibility" class="profile__select">
						...
						<option value="<?php echo esc_attr( $key ); ?>"
												<?php
												if ( $form && isset( $form['profile_events_attended_visibility'] ) && "{$key}" === $form['profile_events_attended_visibility'] ) :
													?>
													<?php
else :
	?>
							<?php
							if ( isset( $community_fields['profile_events_attended_visibility'] ) && "{$key}" === $community_fields['profile_events_attended_visibility'] ) :
								?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>
			...
			<div class="profile__form-field">
				...
				<div class="profile__select-container">
					...
					<select id="profile-events-organized-visibility" name="profile_events_organized_visibility" class="profile__select">
						...
						<option value="<?php echo esc_attr( "{$key}" ); ?>"
												<?php
												if ( $form && isset( $form['profile_events_organized_visibility'] ) && "{$key}" === $form['profile_events_organized_visibility'] ) :
													?>
													<?php
else :
	?>
							<?php
							if ( isset( $community_fields['profile_events_organized_visibility'] ) && "{$key}" === $community_fields['profile_events_organized_visibility'] ) :
								?>
	selected<?php endif; ?><?php endif; ?>><?php echo esc_html( $value ); ?></option>
						<?php endforeach; ?>
					</select>

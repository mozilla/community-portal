<?php if($complete === true): ?>
    ...
    <form class="profile__form" id="complete-profile-form" method="post" novalidate>
        ...
        <section class="profile__form-container">
            ...
            <div class="profile__form-field">
                <div class="profile__input-container">
                    <label class="profile__label" for="twitter"><?php print __("Twitter profile URL (optional)"); ?></label>
            ...
            <div class="profile__form-field">
                <div class="profile__input-container">
                    <label class="profile__label" for="linkedin"><?php print __("LinkedIn profile URL (optional)"); ?></label>
            ...
            <div class="profile__form-field">
                <div class="profile__input-container">
                    <label class="profile__label" for="github"><?php print __("Github profile URL (optional)"); ?></label>
            ...
            <div class="profile__form-field">
                <div class="profile__input-container">
                    <label class="profile__label" for="telegram"><?php print __("Telegram profile URL (optional)"); ?></label>

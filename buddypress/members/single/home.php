<?php
    ...
    $visibility_options = Array(
        ...
        PrivacySettings::PUBLIC_USERS   =>  __('Public'),
        PrivacySettings::PRIVATE_USERS   =>  __('Private'),
    );
?>
...
<div class="profile">
    ...
    <div class="profile__container">
        <section class="profile__success-message-container"> 
            ...
            <div class="profile__button-container">
                <a href="" class="profile__button"><?php print __('Complete your profile'); ?></a><a href="" class="profile__button profile__button--secondary"><?php print __('Go back to browsing'); ?></a>
            </div>
        </section>
    </div>
    <?php else: ?>
    ...
    <form class="profile__form" id="complete-profile-form" method="post" novalidate>
        <section class="profile__form-container profile__form-container--first">
            <div class="profile__form-field profile__form-field">
                <h2 class="profile__form-title"><?php print __("Primary Information"); ?></h2>
            </div>
            <div class="profile__form-visibility">
                <?php print __('Visibility Settings'); ?>
                <div class="profile__select-container">
                    ...
                    <select id="profile-visibility" name="profile_visibility" class="select">
            ...
            <div class="profile__form-field">
                ...
                <input type="text" name="username" id="username" class="profile__input<?php if($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($form['username']) || (isset($form['username']) && empty(trim($form['username'])) )): ?> profile__input--error<?php endif; ?>" placeholder="<?php print __("Username"); ?>" value="<?php print isset($form['username']) ? $form['username'] : $user->user_nicename; ?>"  required/>
                <div class="form__error-container<?php if($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($form['username']) || (isset($form['username']) && empty(trim($form['username'])) )): ?> form__error-container--visible<?php endif; ?>">
            ...
            <div class="profile__form-visibility">
                <div class="profile__select-container">
                    ...
                    <select id="username-visibility" name="username_visibility" class="select select--disabled" disabled>
                        <option value="<?php print PrivacySettings::PUBLIC_USERS; ?>"><?php print __('Public'); ?></option>
                    </select>
                </div>
            </div>
            <hr class="profile__keyline" />
            ...
            <div class="profile__form-visibility">
                <div class="profile__select-container">
                    ...
                    <select id="firstname-visibility" name="first_name_visibility" class="select">
                        <?php foreach($visibility_options AS $key   =>  $value): ?>
            ...
            <div class="profile__form-visibility profile__form-visibility--no-span">
                <div class="profile__select-container">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g>
                            <path d="M8.12499 9L12.005 12.88L15.885 9C16.275 8.61 16.905 8.61 17.295 9C17.685 9.39 17.685 10.02 17.295 10.41L12.705 15C12.315 15.39 11.685 15.39 11.295 15L6.70499 10.41C6.51774 10.2232 6.41251 9.96952 6.41251 9.705C6.41251 9.44048 6.51774 9.18683 6.70499 9C7.09499 8.62 7.73499 8.61 8.12499 9Z" fill="black" fill-opacity="0.54"/>
                    ...
                    <select id="lastname-visibility" name="last_name_visibility" class="select">
                        <?php foreach($visibility_options AS $key   =>  $value): ?>
            ...
            <div class="profile__form-field">
                ...
                <input type="text" name="email" id="email" class="profile__input<?php if($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($form['email']) || (isset($form['email']) && empty(trim($form['email'])) )): ?> profile__input--error<?php endif; ?>" placeholder="<?php print __("Email"); ?>" value="<?php print isset($form['email']) ? $form['email'] : $user->user_email; ?>" required/>
                <div class="form__error-container<?php if($_SERVER['REQUEST_METHOD'] === 'POST' && !isset($form['email']) || (isset($form['email']) && empty(trim($form['email'])) )): ?> form__error-container--visible<?php endif; ?>">
                    <div class="form__error"><?php print __("This field is required"); ?></div>
                </div>
            ...
            <div class="profile__form-visibility  profile__form-visibility--no-span">
                <div class="profile__select-container">
                    ...
                    <select id="email-visibility" name="email_visibility" class="select">
                        <?php foreach($visibility_options AS $key   =>  $value): ?>

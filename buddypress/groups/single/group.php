                                ...
                                <div class="group__community-links">
                                    ...
                                    <?php if(isset($group_meta['group_telegram']) && strlen($group_meta['group_telegram']) > 0): ?>
                                        <div class="group__community-link-container">
                                            ...
                                            <a href="<?php print filter_var($group_meta['group_telegram'], FILTER_VALIDATE_URL) || preg_match('/\.com/i', $group_meta['group_telegram']) ? mozilla_verify_url($group_meta['group_telegram']) : "https://t.me/{$group_meta['group_telegram']}"; ?>" class="group__social-link"><?php print __("Telegram", "community-portal"); ?></a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if(isset($group_meta['group_facebook']) && strlen(trim($group_meta['group_facebook'])) > 0): ?>
                                        <div class="group__community-link-container">
                                            ...
                                            <a href="<?php print filter_var($group_meta['group_facebook'], FILTER_VALIDATE_URL) || preg_match('/\.com/i', $group_meta['group_facebook']) ? mozilla_verify_url($group_meta['group_facebook']) : "https://facebook.com/{$group_meta['group_telegram']}" ?>" class="group__social-link"><?php print __("Facebook", "community-portal"); ?></a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if(isset($group_meta['group_discourse']) && strlen(trim($group_meta['group_discourse'])) > 0): ?>
                                        <div class="group__community-link-container">
                                            ...
                                            <a href="<?php print filter_var($group_meta['group_discourse'], FILTER_VALIDATE_URL) || preg_match('/\.com/i', $group_meta['group_discourse']) ? mozilla_verify_url($group_meta['group_discourse']) : "https://discourse.mozilla.org/u/{$group_meta['group_discourse']}/summary"; ?>" class="group__social-link"><?php print __("Discourse", "community-portal"); ?></a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if(isset($group_meta['group_github']) && strlen(trim($group_meta['group_github'])) > 0): ?>
                                        <div class="group__community-link-container">
                                            ...
                                            <a href="<?php print filter_var($group_meta['group_github'], FILTER_VALIDATE_URL) || preg_match('/\.com/i', $group_meta['group_github']) ? mozilla_verify_url($group_meta['group_github']) : "https://www.github.com/{$group_meta['group_github']}"; ?>" class="group__social-link"><?php print __("Github", "community-portal"); ?></a>
                                        </div>
                                    <?php endif; ?>
                                    <?php if(isset($group_meta['group_twitter']) && strlen(trim($group_meta['group_twitter'])) > 0): ?>
                                        <div class="group__community-link-container">
                                            ...
                                            <a href="<?php print filter_var($group_meta['group_twitter'], FILTER_VALIDATE_URL) || preg_match('/\.com/i', $group_meta['group_twitter']) ? mozilla_verify_url($group_meta['group_twitter']) : "https://www.twitter.com/{$group_meta['group_twitter']}"; ?>" class="group__social-link"><?php print __("Twitter", "community-portal"); ?></a>
                                        </div>
                                    <?php endif; ?>

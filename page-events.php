  ...
  <div class="events__header">
    <div class="row middle-md events__container ">
      <div class="col-md-6 events__header__text">
        ...
        <p class="events__text">Fine and event near you below, or <a href="<?php echo add_query_arg(array('action' => 'edit'), get_site_url('','events/edit-event'))?>">create an event</a></p>
      </div>
    </div>
  </div>
  <div 

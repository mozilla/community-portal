  ...
  <div class="events__header">
    ...
    ?>">
      <div class="col-md-6 events__header__text">
        ...
        <h1 class="events__title--edit">Create An Event</h1>
        <p class="events__text">A short paragraph about why events are great and why people should look for some near them.</p>
        <p class="events__text">Fine and event near you below, or <a href="<?php echo add_query_arg(array('view' => 'organized', 'action' => 'edit'), get_site_url('','events'))?>">create an event</a></p>
        <p class="events__text--edit">* Optional Information</p>
      </div>
    </div>
  </div>
  <div 

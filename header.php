<?php 
	...
	$original_query = htmlspecialchars($_GET['s'], ENT_QUOTES, 'UTF-8');
	...
	if (
		...
		$original_query = htmlspecialchars(stripslashes($_GET['s']), ENT_QUOTES, 'UTF-8');
        ...
        <nav class="nav">
            <div class="nav__header">
                <div class="nav__container">
                    <a href="/">
                        <img src="<?php print get_stylesheet_directory_uri()."/images/logo.svg"; ?>" />
                    </a>
                    <div class="nav__login">
                        <?php if(is_user_logged_in()): ?>
                            ...
                            <a href="/wp-login.php?action=logout" class="nav__logout-link"><?php _e('Log Out', 'community-portal'); ?></a>
                        <?php else: ?>
                            <a href="/wp-login.php?action=login" class="nav__login-link"><?php _e('Log In / Sign Up', 'community-portal'); ?></a>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="nav__search-container">
                        ...
                        <form method="GET" action="/">
                            <input type="text" class="nav__search" placeholder="<?php _e('Seach', 'community-portal'); ?>" name="s" value="<?php if(isset($original_query) && strlen($original_query) > 0): ?><?php print $original_query; ?><?php endif; ?>" />
                        </form>
                    </div>
                ...
                <div class="nav__content">
                    ...
                    <div class="nav__menu-container">
                        ...
                        <?php if(is_user_logged_in()): ?>
                            ...
                            <a href="/wp-login.php?action=logout" class="nav__logout-link"><?php _e('Log Out', 'community-portal'); ?></a>
                        <?php else: ?>
                            <a href="/wp-login.php?action=login" class="nav__login-link nav__login-link--mobile"><?php _e('Log In / Sign Up', 'community-portal'); ?></a>
                        <?php endif; ?>
                        ...
                        <div class="nav__search-container">
                            ...
                            <form method="GET" action="/">
                                <input type="text" class="nav__search" placeholder="<?php _e('Seach', 'community-portal'); ?>" name="s" value="<?php if(isset($_GET['s']) && strlen($_GET['s']) > 0): ?><?php print $original_query; ?><?php endif; ?>" />
                            </form>
                        </div>

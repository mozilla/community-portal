...
<div class="em-search-wrapper row">
	<div class="em-events-search em-search col-lg-7 col-sm-12">
		<?php
			...
			$query_country      = isset( $_GET['country'] ) && strlen( sanitize_text_field( wp_unslash( $_GET['country'] ) ) ) > 0 ? sanitize_text_field( wp_unslash( urldecode( wp_unslash( $_GET['country'] ) ) ) ) : false;

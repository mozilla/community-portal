      ...
      <div class="row">
        <div class="card__address col-md-5 col-sm-12">
          <?php 
            ...
            if (isset($location->location_region) && strlen($location->location_region) > 0 && $location->location_region !== 'online' && $location->location_country !== 'OE') {
            ?>
        ...
        <?php
          ...
          if (isset($location->location_region) && strlen($location->location_region) && $location->location_region !== 'online' && $location->location_country !== 'OE') {
          ?>

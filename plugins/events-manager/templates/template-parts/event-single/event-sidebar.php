<div class="col-lg-4 col-sm-12 events-single__sidebar">
        ...
        <div class="card events-single__attributes">
            ...
            <?php if (isset($external_url) && strlen($external_url) > 0 && filter_var($external_url, FILTER_VALIDATE_URL)): ?>
                <div class="col-lg-12 col-md-6 col-sm-12">
                    <p class="events-single__label"><?php _e('Links', 'community-portal') ?></p>
                    <p><a href="<?php echo mozilla_verify_url($external_url, false) ?>" class="events-single__externam-link"><?php echo $external_url; ?></a></p>
                </div>
            <?php endif; ?>
            <?php if (is_array($categories)): ?>
                <div class="col-lg-12 col-md-6 col-sm-12">
                    <p class="events-single__label"><?php _e('Tags', 'community-portal'); ?></p>
            ...
            <?php if($initiative): ?>
                ...
                ?>
                <div class="col-lg-12 col-md-6 col-sm-12">
                    <p class="events-single__label"><?php _e('Part of', 'community-portal'); ?></p>
	...
	<div class="card events-single__language">
		<div class="row">
			<div class="col-lg-12 col-md-6 col-sm-12">
                <p class="events-single__label"><?php _e('Preferred Language', 'community-portal') ?></p>
                <p>

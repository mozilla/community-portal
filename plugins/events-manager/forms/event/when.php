...
<div id="em-form-with-recurrence" class="event-form-with-recurrence event-form-when">
    <div class="em-date-range event-creator__three-up">
        <div class="wide wide--md-half">
            <label for="start-date" class="em-event-text event-creator__label"><?php __( 'Start date *', 'commuity-portal'); ?></label>				
        ...
        <div class="wide wide--md-half">
            <label for="end-date" class="em-event-text event-creator__label"><?php __('End Date *','commuity-portal'); ?></label>
	...
	<div class="event-creator__three-up">
        <div class="wide wide--md-third">
            <label for="start-time" class="em-event-text event-creator__label"><?php __('Start time *','commuity-portal'); ?></label>
        ...
        <div class="wide wide--md-third">
            <label for="end-time" class="em-event-text event-creator__label"><?php __('End time *','commuity-portal'); ?></label>
        ...
        <div class="thin wide--md-third">
            <label class="event-creator__label" for="event-timezone event-creator__label"><?php __('Timezone *', 'commuity-portal'); ?></label>

...
<div class="em-ticket-form">
	...
	<div class="em-ticket-form-main">
		<div class="ticket-name">
			<label title="<?php __('Enter a ticket name.','community-portal'); ?>"><?php __('Name','community-portal') ?></label>
		...
		<div class="ticket-description">
			<label><?php __('Description', 'community-portal') ?></label>
		...
		<div class="ticket-price"><label><?php __('Price', 'community-portal') ?></label><input type="text" name="em_tickets[<?php echo $col_count; ?>][ticket_price]" class="ticket_price" value="<?php echo esc_attr($EM_Ticket->get_price_precise(true)) ?>" /></div>
		<div class="ticket-spaces">
			<label title="<?php __('Enter a maximum number of spaces (required).', 'community-portal'); ?>"><?php __('Spaces','community-portal') ?></label>
	...
	<div class="em-ticket-form-advanced" style="display:none;">
      ...
      <label title="<?php __('Leave either blank for no upper/lower limit.', 'community-portal'); ?>"><?php echo esc_html_x('At least','spaces per booking','community-portal');?></label>
			...
			<?php __('spaces per booking', 'community-portal')?>
		</div>
		...
		<div class="ticket-dates em-time-range em-date-range">
			<div class="ticket-dates-from">
				<label title="<?php __('Add a start or end date (or both) to impose time constraints on ticket availability. Leave either blank for no upper/lower limit.','community-portal'); ?>">
					<?php __('Available from','community-portal') ?>
				</label>
			...
			<div class="ticket-dates-to">
				<label title="<?php __('Add a start or end date (or both) to impose time constraints on ticket availability. Leave either blank for no upper/lower limit.','community-portal'); ?>">
					<?php __('Available until','community-portal') ?>
				</label>
		...
		<div class="ticket-required">
			<label title="<?php __('If checked every booking must select one or the minimum number of this ticket.','community-portal'); ?>"><?php __('Required?','community-portal') ?></label>
		...
		<div class="ticket-type">
			<label><?php __('Available for','community-portal') ?></label>
			<select name="em_tickets[<?php echo $col_count; ?>][ticket_type]" class="ticket_type">
				...
				<option value="members" <?php if($EM_Ticket->ticket_members) echo 'selected="selected"'; ?>><?php __('Logged In Users','community-portal'); ?></option>
				<option value="guests" <?php if($EM_Ticket->ticket_guests) echo 'selected="selected"'; ?>><?php __('Guest Users','community-portal'); ?></option>
			</select>
		</div>
	...
	<div class="ticket-options">
		<a href="#" class="ticket-options-advanced show"><span class="show-advanced"><?php __('Show Advanced Options','community-portal'); ?></span><span class="hide-advanced" style="display:none;"><?php __('Hide Advanced Options','community-portal'); ?></span></a>
	</div>
</div>	
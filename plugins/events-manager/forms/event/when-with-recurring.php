...
<div id="em-form-with-recurrence" class="event-form-with-recurrence event-form-when">
    ...
    <div class="wide wide--md-third">
      <label for="start-time" class="em-event-text event-creator__label"><?php print __('Start time *','commuity-portal'); ?></label>
    ...
    <div class="wide wide--md-third">
      <label for="end-time" class="em-event-text event-creator__label"><?php print __('End time *','commuity-portal'); ?></label>

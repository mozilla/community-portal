				...
				<div class="campaigns__active-campaign-hero-container">
					...
					<div class="campaigns__active-campaign-title-container">
						...
						<div class="campaigns__active-campaign-date-container">
							<?php print $current_campaign_start_date; ?>
										<?php
										if ( $current_campaign_end_date ) :
											?>
								 - <?php print $current_campaign_end_date; ?><?php endif; ?>
						</div>
				...
				<div class="campaigns__incoming-campaign-container">
					...
					<div class="campaigns__active-campaign-hero-container">
						...
						<div class="campaigns__active-campaign-title-container">
							...
							<div class="campaigns__active-campaign-date-container">
								<?php print $incoming_campaign_start_date; ?>
											<?php
											if ( $incoming_campaign_end_date ) :
												?>
									 - <?php print $incoming_campaign_end_date; ?><?php endif; ?>
							</div>
		...
		<div class="campaigns__container">
							...
							<div class="campaigns__active-campaign-date-container campaigns__active-campaign-date-container--card">
								<?php print $campaign_start_date; ?>
											...
											if ( $campaign_end_date ) :
												?>
									 - <?php print $campaign_end_date; ?><?php endif; ?>
							</div>
						</div>
					</div>
			...
			<div class="campaigns__pagination">
				<div class="campaigns__pagination-container">
					...
					<a href="/campaigns/?a=<?php print $x + 1; ?>" class="campaigns__pagination-link
													   <?php
														if ( $p == $x + 1 ) :
															?>
						 campaigns__pagination-link--active<?php endif; ?>
							...
							if ( $x === $page_max - 1 ) :
								?>
						 campaigns__pagination-link--last<?php endif; ?>"><?php print ( $x + 1 ); ?></a>
					<?php endfor; ?>
						<?php
						if ( $total_pages > $range && $p < $total_pages - 1 ) :
							?>
							&hellip; <a href="/campaigns/?p=<?php print $total_pages; ?>" class="campaigns__pagination-link
							<?php
							if ( $p === $total_pages ) :
								?>
							 campaigns__pagination-link--active<?php endif; ?>"><?php print $total_pages; ?></a><?php endif; ?>

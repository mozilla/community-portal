		...
		<div class="row">
			...
			<div class="col-lg-6 newsletter__signup">
				...
				<div class="newsletter__success">
					<h2>Thanks!</h2>
					<p>If you haven’t previously confirmed a subscription to a Mozilla-related newsletter you may have to do so. Please check your inbox and spam filter for an email from us.</p>
				</div>
			</div>
		</div>
	</div>

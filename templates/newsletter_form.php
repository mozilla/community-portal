...
?>
<h2 class="profile__form-title"><?php _e('Get Updates', 'community-portal') ?></h2>
<p><?php _e('Subscribe to our newsletter and join Mozillians all around the world and learn about impactful opportunities to support Mozilla’s mission.', 'community-portal') ?></p>
...
<div class="row profile__newsletter__container">
	<div class="col-lg-4 profile__newsletter__fields">
		...
		<span class="newsletter__error"><?php _e('Invalid email.', 'community-portal') ?></span>
	</div>
	<div class="col-lg-4 profile__newsletter__fields">
		...
		<select class="newsletter__dropdown" id="newsletter-country" name="newsletter-country">
			<option value="" disabled="" selected=""><?php _e('Country or region', 'community-portal') ?></option>
	...
	<div class="col-lg-3 profile__newsletter__fields">
		...
		<select id="newsletter-language" class="newsletter__dropdown" name="newsletter-language">
			<option value="" disabled="" selected=""><?php _e('Language', 'community-portal') ?></option>
	...
	<div class="col-lg-12">
		<p class="newsletter__subtext"><?php _e('We’ll default to English but send in these languages whenever we can.', 'community-portal') ?></p>
		<div class="cpg">
			<input class="checkbox--hidden" type="checkbox" id="newsletter">
			<label class="cpg__label" for="newsletter">
				<?php _e('Yes, subscribe me to the newsletter', 'community-portal') ?>
			</label>
